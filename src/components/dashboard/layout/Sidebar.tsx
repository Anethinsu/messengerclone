...
import { Home, MessageCircle, Users, Settings, HelpCircle } from "lucide-react";
...
const defaultNavItems: NavItem[] = [
  { icon: <Home size={20} />, label: "Home", isActive: false },
  { icon: <MessageCircle size={20} />, label: "Messages", isActive: true },
...
const Sidebar = ({
  ...
  return (
    <div className="w-[280px] h-full bg-white border-r border-gray-200 flex flex-col">
      <div className="p-6">
        <h2 className="text-xl font-semibold mb-2 text-gray-900">Messenger</h2>
